 ...
 */
final class Version20220203115221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE payment_request ADD CONSTRAINT FK_22DE8175CB708DA2 FOREIGN KEY (from_order_id) REFERENCES commande (id)');
    }
