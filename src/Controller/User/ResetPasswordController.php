...
class ResetPasswordController extends AbstractController
{
     ...
     */
    public function request(Request $request, MailerInterface $mailer, CartService $cartService): Response
    {
     ...
     */
    public function checkEmail(CartService $cartService): Response
    {
        $cart = $cartService->get();
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('no-reply@summerfield.com', 'No Reply'))
            ->to($user->getEmail())
