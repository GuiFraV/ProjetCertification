...
use App\Form\Seller\Commande1Type;
...
/**
 * @Route("/seller/commande")
 */
class SellerCommandeController extends AbstractController
{
    /**
     * @Route("/", name="seller_commande_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="seller_commande_new", methods={"GET", "POST"})
     */
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        // Je créer la variable form dans laquelle je créer un formulaire à partir du modèle Commande1Type
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->flush();
            // Redirection du navigateur vers la route interne 'seller_commande_index'
            // le return stop la fonction
            return $this->redirectToRoute('seller_commande_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    /**
     * @Route("/{id}", name="seller_commande_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="seller_commande_edit", methods={"GET", "POST"})
     */
    public function edit(Request $request, Commande $commande, EntityManagerInterface $entityManager): Response
    {
        // Je créer la variable form dans laquelle je créer un formulaire à partir du modèle d'Commande1Type
        // Le form devra remplir $commande
        $form = $this->createForm(Commande1Type::class, $commande);
        // Récupération de données saisis par l'utilisateur grace à $request
        $form->handleRequest($request);
    ...
    /**
     * @Route("/{id}", name="seller_commande_delete", methods={"POST"})
     */
